              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="flex">
                  <Input 
                    type="text" 
                    readOnly 
                    value={`${window.location.origin}/booking?provider=${providerId}`} 
                  ...
                  <Button 
                    ...
                    onClick={() => {
                      navigator.clipboard.writeText(`${window.location.origin}/booking?provider=${providerId}`);
                    }}
                  >
                ...
                <div className="mt-4 flex space-x-2">
                  <Button size="sm" className="bg-[#25D366] hover:bg-[#20bd5a]" onClick={() => {
                    const url = `https://wa.me/?text=${encodeURIComponent(`Faça seu agendamento online: ${window.location.origin}/booking?provider=${providerId}`)}`;
